<?php
/*
 *	Template Name: 04 - News-Listing - Template
 */ ?>
...
dev_comment('tpl: 04-news-listing-template');
...
<div id="news-content">
	...
	<div class="row">
		...
		<?php if (have_posts()) : while ($wp_query->have_posts()) : $wp_query->the_post(); ?>
			...
			<div class="bigblock col-md-12">
				<div class="newsframe">
					...
					<a href="<?php if ($link) echo $link['url']; else the_permalink();?>" target="<?php if($link) echo $link['target'] ?>">
		...
		<div class="col-md-4 rightsection">
			...
			<?php include_locate( 'template-parts/sidebar-news.php' ); ?>
			<!-- <?php include_locate( 'template-parts/sidebar-news-categories.php' ); ?> -->
